...
gulp.task('copy', function() {
  ...
  gulp.src(['node_modules/popper.js/dist/umd/popper.min.js'])
    .pipe(gulp.dest('build/static/vendor/popper'));

  gulp.src(['node_modules/jquery.easing/*.min.js'])
    .pipe(gulp.dest('build/static/vendor/jquery-easing'));

  gulp.src([
      'node_modules/font-awesome/css/*.min.css'
    ])
    .pipe(gulp.dest('build/static/vendor/font-awesome/css'));

  gulp.src([ 'node_modules/font-awesome/fonts/*'])
  .pipe(gulp.dest('build/static/vendor/font-awesome/fonts'));
      //
    //
    gulp.src(['img/**','img/**/*'])
