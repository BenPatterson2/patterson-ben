...
### Creating aliases for different env variables in production, development etc

In your package.json add something like the following
{
  "env-var-alias":{
    "development":{
      "API":"REACT_APP_DEV_API"
    },

  "production":{
      "API":"REACT_APP_PRODUCTION_API"
    },
  }
  "test":{
      "API":"REACT_APP_TEST_API"
    },
}
>Note: this feature is available with `react-scripts@0.5.0` and higher.
